...
SELECT OfferNo,
       ...
       OffTime
FROM Faculty
         INNER JOIN Offering ON Offering.FacNo = Faculty.FacNo
         INNER JOIN Course ON Course.CourseNo = Offering.CourseNo
WHERE OffYear = 2016
  AND OffTerm = 'FALL'
  AND FacFirstName = 'LEONARD'
...
SELECT Offering.OfferNo,
       ...
       FacLastName
FROM Faculty
         INNER JOIN Offering ON Faculty.FacNo = Offering.FacNo
         INNER JOIN Enrollment ON Offering.OfferNo = Enrollment.OfferNo
         INNER JOIN Student ON Student.StdNo = Enrollment.StdNo
WHERE OffYear = 2017
  AND OffTerm = 'SPRING'
